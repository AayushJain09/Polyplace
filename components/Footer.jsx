                ...
                <div className="flex-1 flexBetweenStart flex-wrap ml-10 md:ml-0 md:mt-8 font-semibold">
                    <div>
                        ...
                        <ul className="font-poppins text-nft-black-1 dark:text-white">
                            <li className="mb-3">
                                <a href="" target="_blank" className="font-poppins dark:text-white text-nft-black-1 font-normal text-base cursor-pointer dark:hover:text-nft-gray-1 hover:text-nft-black-1 my-3 transition duration-300" rel="noreferrer">Smart Contract</a>
                            </li>
                            <li className="mb-3">
                                <a href="" target="_blank" className="font-poppins dark:text-white text-nft-black-1 font-normal text-base cursor-pointer dark:hover:text-nft-gray-1 hover:text-nft-black-1 my-3 transition duration-300" rel="noreferrer">The Project</a>
                            </li>
                            <li className="mb-3">
                ...
                <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7 mb-0">
                    ...
                    <div className="flex flex-row sm:mt-4">
                        <div className={`${theme === 'light' ? 'filter invert' : ''} space-x-6`}>
                            <a target="_blank" href="https://github.com/" alt="github" rel="noreferrer">
